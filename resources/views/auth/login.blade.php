...
<head>
    ...
    <link rel="icon"
        href="{{asset('assets/images/logo-sd.png')}}"
        type="image/png">
                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                            ...
                            <p class="text-lead text-white">Sistem Informasi Penjualan Koperasi SD N 3 Saba</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-5 col-md-7">
                    <div class="card bg-secondary border border-soft mb-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            <div class="text-center text-gray mb-4"><small><img src="{{asset('assets/images/logo-sd.png')}}" height="70px"></small></div>
                                ...
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-merge input-group-alternative">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                            ...
                                            placeholder="username" type="username" name="username" value="{{ old('username') }}">
                                            @error('username')
